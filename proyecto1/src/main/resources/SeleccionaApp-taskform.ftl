<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("out_appList");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid out_appList");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: proceso1.SeleccionaApp
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">in_appList</label>
                            		<div class="div_checkbox">
                              		${in_appList}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">out_appList</label>
                            		<div class="div_texbox">
                              		<input name="out_appList" type="text" class="textbox" id="out_appList" value="${out_appList}" />
                            		</div>
