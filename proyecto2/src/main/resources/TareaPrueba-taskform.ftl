<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("prueba_out");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid prueba_out");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: proceso2.TareaPrueba
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">prueba_in</label>
                            		<div class="div_checkbox">
                              		${prueba_in}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">prueba_out</label>
                            		<div class="div_texbox">
                              		<input name="prueba_out" type="text" class="textbox" id="prueba_out" value="${prueba_out}" />
                            		</div>
